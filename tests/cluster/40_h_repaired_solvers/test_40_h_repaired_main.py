...
print("Starting...")
folder = "test_40_h_repaired"
path = os.path.join("../../../results-data", folder)
model = PerfusionGasExchangeModel(solver='gmres', folder_path=path, params=params)
...
solution = model.sim_t(hb=True, save=True, guess=x, preconditioner='test')
print("Done")