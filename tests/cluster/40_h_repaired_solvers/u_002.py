...
nl_guess = model.sim_t(hb=True, save=False, guess=x, solver="bicgstab", preconditioner="default")
model.params["u_in"] = 200
print(f"Changed inlet speed u_in to normal, {str(model.params['u_in'])}")
solution = model.sim_t(hb=True, save=True, guess=nl_guess, solver="bicgstab", preconditioner="default")
print("Done")