...
class GammaIn(SubDomain):
    ...
    def inside(self, x, on_boundary):
        ...
        '''
#         print("Estamos en x=", x)
#         print("Dimensión x[0]=", x[0])

#         if near(x[0], self.dir_min, self.tol):
#             print(near(x[0], self.dir_min, self.tol))
...
#         )
        return (near(x[1], self.dir_min, self.tol) or near(x[1], self.dir_max, self.tol) or near(x[2], self.dir_min, self.tol) or near(x[2], self.dir_max, self.tol))
