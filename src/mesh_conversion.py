...
path = '//wsl.localhost/Ubuntu-18.04/home/bnherrerac/alveolar-perfusion-transport-modeling/raw-data/rve_40_flat/tetgen/'
...
stl_name = 'tetra_mesh_nofix.stl'
mesh.write(path + stl_name)
